...
export default function Home() {
  return (
    <>
      <Head>
        <title>Larry Gr-Polanco | larrygrpolanco.com</title>
        <meta
          name='viewport'
        ...
        <meta
          ...
          content='A personal portfolio website for Larry Grullon-Polanco. 
            Languag Teacher and researcher, musician, and programmer.
          '
        />
        <meta
          name='description'
        ...
        <meta
          property='og:title'
          content='Larry Gr-Polanco | larrygrpolanco.com'
          key='title'
        />
        ...
        <Link href={'https://jordantwells.com'} />
      </Head>
